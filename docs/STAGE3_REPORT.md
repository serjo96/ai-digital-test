...
> Исторический итог B2. Позднейшие B3, human review и holdout описаны в [STAGE4_REPORT.md](STAGE4_REPORT.md), [STAGE5_REPORT.md](STAGE5_REPORT.md) и текущей передаче [NEXT_STEPS.md](NEXT_STEPS.md).
