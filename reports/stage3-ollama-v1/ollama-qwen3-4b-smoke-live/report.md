# ollama-qwen3-4b-smoke-live — B2-v1
...
| api.input_tokens | 763 | N/A | N/A | run | not_applicable; measured |
| api.output_tokens | 507 | N/A | N/A | run | not_applicable; measured |
| api.retries | 0 | N/A | N/A | run | not_applicable; measured |
| api.tokens | 1270 | N/A | N/A | run | not_applicable; measured |
...
| timing.pipeline | 37917.625042 | N/A | N/A | run | not_applicable; measured |
| timing.wall | 37979.766417 | N/A | N/A | run | not_applicable; measured |
...
AI: {"targetRows":1,"jobs":1,"failedJobs":1,"origin":"real","requestHashes":["10ef47b3d794eaf53a95fe815491b2faffd2535bdc9ac7a94b23ab6e907fbe86"]}; usage: {"calls":1,"errors":1,"retries":0,"cacheHits":0,"inputTokens":763,"outputTokens":507,"tokens":1270,"cost":null}. Test fixtures are not real AI quality. Missing pricing/usage is N/A.
...
Timing: {"protocol":"cli-through-result-v1","node":"v24.14.1","platform":"darwin","arch":"arm64","pipelineMs":37917.625042}. Wall measurement ends after result/diagnostics, before metric/report serialization.
