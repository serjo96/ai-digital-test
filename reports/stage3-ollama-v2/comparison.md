# Ollama: stage 3 summary

Experimental development baseline, provisional. Accepted product baseline: B1-v2.

| Model | Extraction valid | Proposed correct/extra/missing | Accepted correct/extra/missing | Shadow valid | Dangerous/unconfirmed | Median/p95 extraction ms |
|---|---:|---:|---:|---:|---:|---:|
