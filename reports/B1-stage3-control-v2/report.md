# B1-stage3-control-v2 — B1-v2

Status: success; mode: code-only; matching labels: **provisional**; development only. Holdout not evaluated.
...
| ai.failed_jobs | N/A | N/A | N/A | run | not_applicable; not_implemented |
| ai.target_rows | N/A | N/A | N/A | run | not_applicable; not_implemented |
...
| timing.pipeline | 36.99858400000002 | N/A | N/A | run | not_applicable; measured |
| timing.wall | 71.50545799999998 | N/A | N/A | run | not_applicable; measured |
...
AI: null; usage: {"calls":0,"errors":0,"tokens":0,"cost":0}. Test fixtures are not real AI quality. Missing pricing/usage is N/A.
...
Code: {"commit":"24594e8dc5e8ddfb8fc38994f86f496f92f5ceaf","dirty":true,"implementationHash":"f74e5f577810f0d52d97da69c34cd102b24dc930d7d9f1dc3b72dbd56554b2f0"}

Timing: {"protocol":"cli-through-result-v1","node":"v24.14.1","platform":"darwin","arch":"arm64","pipelineMs":36.99858400000002}. Wall measurement ends after result/diagnostics, before metric/report serialization.
